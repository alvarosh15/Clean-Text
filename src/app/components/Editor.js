  ...
  return (
    <>
      <div className="relative h-96 w-full grow">
        <textarea
          spellCheck="false"
          className="scrollbar-hide absolute z-10 min-h-full w-full grow resize-none break-words rounded-md bg-transparent pl-2 text-justify text-transparent caret-white focus:outline-none"
        ...
        <div
          ref={previewRef}
          className="scrollbar-hide z-0 h-full w-full grow resize-none overflow-y-auto break-words rounded-md bg-black pl-2 text-justify text-white focus:outline-none"
